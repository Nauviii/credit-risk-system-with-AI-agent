...
def test_split_boundaries_are_inclusive_and_exclusive_correctly():
    df = pl.DataFrame({"issue_d": ["Dec-2015", "Jan-2016", "Dec-2016", "Jan-2017"]})
    config = {"train_end": "2015-12", "oot_test_start": "2016-01", "oot_test_end": "2016-12"}
    result = tag_split(df, config)
    assert result["split"].to_list() == ["train", "oot_test", "oot_test", "excluded"]
