...
from credit_risk.features.build_dataset import SCORECARD_FEATURES, gbm_features, tag_split


def test_split_boundaries_are_inclusive_and_exclusive_correctly():
    df = pl.DataFrame(
        {"issue_d": ["Dec-2014", "Jan-2015", "Dec-2015", "Jan-2016", "Dec-2016", "Jan-2017"]}
    )
    config = {
        "train_start": "2013-01",
        "train_end": "2014-12",
        ...
        "oot_test_start": "2016-01",
        "oot_test_end": "2016-12",
    }
...
def test_target_timing_and_platform_columns_never_become_features():
    ...
    from credit_risk.data.schema import LEAKAGE_COLUMNS, PLATFORM_COLUMNS, TARGET_TIMING_COLUMNS
